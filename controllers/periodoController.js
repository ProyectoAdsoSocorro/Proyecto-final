const Period = require('../models/periodo');
...
const getById = async (req, res) => {
    try {
        const period = await Period.findById(req.params.id).populate('school', 'name');
...
// PUT /api/periodos/:id/desactivar
